...
function heateorSssMoreSharingPopup(elem, postUrl, postTitle, twitterTitle){
	 ...
	 facebook: {
	  ...
	  gab: {
	   ...
	   gettr: {
		...
		title: "Gettr",
		redirect_url: "https://gettr.com/share?url=%encoded_post_url%" + postTitle + "&url=" + postUrl,
	   ...
	   MeWe: {
		...
		title: "MeWe",
		redirect_url: "https://mewe.com/share?link=%encoded_post_url%" + postTitle + "&url=" + postUrl,
	  ...
	  Outlook_com: {
		...
		title: "Outlook.com",
		redirect_url: "https://mail.live.com/default.aspx?rru=compose?subject=%post_title%&body=%encoded_post_url%&lc=1033&id=64855&mkt=en-us&cbcxt=mai"+postUrl,
	...
	for(var i in heateorSssMoreSharingServices){
		...
		heateorSssMoreSharingServicesHtml += '"><span class="heateor_sss_svg heateor_sss_s__default heateor_sss_s_'+ heateorSssMoreSharingServices[i].title +'" style="background-color:' + heateorSssMoreSharingServices[i].background_color + ';width:22px;height:22px;display:block;float:left;" title="'+ heateorSssMoreSharingServices[i].title +'">'+ heateorSssMoreSharingServices[i].svg +'</span><span style="display:block;float:left;margin-left:3px;line-height:24px;">' + heateorSssMoreSharingServices[i].title + '</span></a></li>';
	}
